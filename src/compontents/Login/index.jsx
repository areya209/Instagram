      ...
      <Container>
        <Row>
          <Col xs={6} id='leftside'>
            <img className="img wow bounceInDown " data-wow-delay="2s" data-wow-animate='15s' src={require('././static/images/ins.jpeg').default} alt="logo" />
          ...
          <Col xs={6}>
            <div className="form_data">
              <form action="">
                ...
                <Link className="facebook-login" to='/tofacebook'>
            ...
            <div className="get-the-app">
              ...
              <div className="badge">
                <a href='https://play.google.com/store/apps/details?id=com.instagram.android&referrer=utm_source%3Dinstagramweb&utm_campaign=loginPage&ig_mid=BBEC2E51-D398-4D2D-AC68-4FBE14134B36&utm_content=lo&utm_medium=badge' target='_blank'>
                  <img className="img2" src={require('././static/images/google_play.png').default}
                    alt="android App"
                  /> </a>
