...
const SignUp = () => {
  ...
  // Connect apis in Django to react form
          ...
          <Col xs={4}>
            <div className="form_data2">
              <form action="" >
                ...
                <p>Sign up to share photos and videos <br></br> with your friends.</p>
                <Link to='/tofacebook'>
                ...
                <input type="email" placeholder="Enter your Email" onChange={handleChange} value={customerSignUp.email} name="email"
                />

                <input type="text" placeholder="Enter your FirstName" onChange={handleChange} value={customerSignUp.first_name} name="first_name"
                />
                <input type="text" placeholder="Enter your LastName" onChange={handleChange} value={customerSignUp.last_name} name="last_name" />
                <input type="text" placeholder="Enter your UserName" onChange={handleChange} value={customerSignUp.username} name="username" />
                <input type="password" placeholder="Enter your Password" onChange={handleChange} value={customerSignUp.password} name="password"
                />
